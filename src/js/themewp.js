...
window.goToSecondPage = function () {
    ...
    $('.themewp-sidebar').removeClass('is-main-page');
    $('.themewp-sidebar').removeClass('is-third-page');
    $('.themewp-sidebar').addClass('is-second-page');
...
window.goToThirdPage = function () {
    ...
    $('.themewp-sidebar').removeClass('is-main-page');
    $('.themewp-sidebar').removeClass('is-second-page');
    $('.themewp-sidebar').addClass('is-third-page');
}
window.goToMainPage = function() {
    ...
    $('.themewp-sidebar').removeClass('is-second-page');
    $('.themewp-sidebar').removeClass('is-third-page');
    $('.themewp-sidebar').addClass('is-main-page');
    currentEditor.unselect();
}
...
$(document).ready(function() {
    ...
    // menu button
    $(document).on('click', '.themewp-sidebar.is-second-page .menu-button.left-menu, .themewp-sidebar.is-third-page .menu-button.left-menu', function() {
        hideMainMenuDropdown();
        goToMainPage();
    });

    // menu button
    $(document).on('click', '.themewp-sidebar.is-main-page .menu-button.left-menu', function() {
        hideMainMenuDropdown();
    ...
    $(document).on('click', '.device-button', function() {
        ...
        $(".themewp-content").removeClass (function (index, className) {
            return (className.match (/(^|\s)device-mode-\S+/g) || []).join(' ');
        });
        $('.themewp-content').addClass('device-mode-' + tagClass);
