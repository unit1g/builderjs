export default class SuperElement {
    constructor(obj) {
        ...
        this.currentHtml = this.obj.html();
        this.currentStyle = this.obj.attr('style');
    }
    ...
    adjustSelectMoveButtonPosition() {
        if (this.isDraggable()) {
            ...
            if (this.isFullRow()) {
                ...
                this.selectMoveButton().css('left', this.obj.offset().left + this.obj.outerWidth() - (this.selectMoveButton().outerWidth()/2) + 4 - 19);
            }
        }
    }
    ...
    // unselect element
    unselect() {
        // record state if element change after unselect
        if (this.currentHtml != this.obj.html() || this.currentStyle != this.obj.attr('style')) {
            currentEditor.recordState();
        }
        ...
        if (typeof(this.unselectCallback) !== 'undefined') {
