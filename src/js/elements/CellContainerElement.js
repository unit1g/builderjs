...
export default class CellContainerElement extends SuperElement  {
    name() {
    ...
    getControls() {
        ...
        return [
            new CellOptionControl(getI18n('cell_options'),
                {
                    count: element.obj.find('[builder-element="CellElement"]').length,
                    layout: element.obj.attr('data-layout'),
                    responsive: element.obj.hasClass('cell-responsive'),
                },
                {
                    setLayout: function(layout) {
                        ...
                        setTimeout(function() {
                            ...
                            currentEditor.adjustIframeSize();
                        }, 350);
                    },
                    setResponsive: function(checked) {
                        if (checked) {
                            element.obj.addClass('cell-responsive');
                        } else {
                            element.obj.removeClass('cell-responsive');
                        }
