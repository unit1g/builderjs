...
export default class CheckoutButtonElement extends SuperElement {
    name() {
    ...
    getControls() {
        ...
        return [
            ...
            new ActionCheckoutButtonControl(getI18n('product'), {name: element.obj.attr('name'), data_action: element.obj.attr('href')}, function(options) {
            ...
            new ButtonOptionControl(
                ...
                function(options) {
                    ...
                    if (typeof(options.align) !== 'undefined') {
                        element.obj.parent().removeClass('text-center');
                        element.obj.parent().css('text-align', options.align).css('display', 'block');
                    }
