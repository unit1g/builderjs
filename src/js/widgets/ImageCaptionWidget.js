    ...
    events() {
        ...
        function showImagePopup(tab = "upload") {
            ...
            window.filemanager_callback = function(url) {
                ...
                idContent.after('<img id="'+id+'" builder-element class="" src="'+ url +'" style="width: auto;"/>');
                idContent.remove();
                var popup = new PopUp();
                popup.hide();
            };
        ...
        function saveImageUpload() {
            ...
            $.ajax({
                ...
                if (jqXHR.status == 200) {
                    idContent.find('.image-caption-placeholder').after('<img id="'+id+'" builder-element class="" src="'+ data.url +'" style="width: auto;"/>');
