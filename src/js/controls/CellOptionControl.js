...
export default class CellOptionControl extends Control {
    renderHtml() {
                        ...
                        <div class="">
                            <div class="d-flex">
                                <div class="mr-auto pr-4">
                                    <label class="label mb-1" style="font-weight:600;">{language.cell.responsive}</label>
                                    <p class="small">{language.cell.responsive.wording}</p>
                                </div>
                                <div class="d-flex align-items-center">
                                    <label style="position: relative;">
                                        <input name="responsive" type="checkbox" class="styled3" />
    ...
    afterRender() {
        ...
        if (_this.value.responsive) {
            _this.selector().find('[name=responsive]').prop('checked', true);
        } else {
            _this.selector().find('[name=responsive]').prop('checked', false);
        }
        ...
        // change responsive
        _this.selector().find('[name=responsive]').on('change', function() {
            var checked = $(this).is(':checked');

            _this.callback.setResponsive(checked);
        });
