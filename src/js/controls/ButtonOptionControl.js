...
export default class ButtonOptionControl extends Control {
    groupId() {
        return 'action';
    }
    ...
    renderHtml() {
        ...
        div.find('.button-option-control .text-color-picker').attr('value', color_value);
    ...
    afterRender() {
        ...
        $('.control-' + thisControl.id).on('change', '#' + input_width_button, function() {
        ...
        //Background color
        $('.control-' + thisControl.id).on('change', '#' + input_id, function() {
            var background_color = $(this).val();
            $('.control-' + thisControl.id + ' #background-color-input-text').val(background_color);

            thisControl.callback({background_color: background_color});
        });

        $('.control-' + thisControl.id).on('change keyup', '#background-color-input-text', function() {
            var background_color = $(this).val();
            $('.control-' + thisControl.id + ' #' + input_id).val(background_color);

            thisControl.callback({background_color: background_color});
        });

        //Text color
        $('.control-' + thisControl.id).on('change', ' .text-color-picker', function() {
            var text_color = $(this).val();
            if (text_color != '') {
                $('.control-' + thisControl.id + ' #text_color_input').val(text_color);
                thisControl.callback({text_color: text_color});
            }
        });

        $('.control-' + thisControl.id).on('change keyup', '#text_color_input', function() {
            var text_color = $(this).val();
            if (text_color != '') {
                $('.control-' + thisControl.id + ' .text-color-picker').val(text_color);
                thisControl.callback({text_color: text_color});
            }
        });

        //Text align
        $('.control-' + thisControl.id).on('click', '.align', function() {
        ...
        //line height
        $('.control-' + thisControl.id).on('click', '.icon-line-height', function() {
         ...
         //Border radius plus
        $('.control-' + thisControl.id).on('click', '#plus-border', function() {
        ...
        //Border radius minus
        $('.control-' + thisControl.id).on('click', '#minus-border', function() {
        ...
        //border color plus
        $('.control-' + thisControl.id).on('click', '#' +plus_border_width, function() {
        ...
        // border color minus
        $('.control-' + thisControl.id).on('click', '#'+ minus_border_width, function() {
            var input = $(this).closest('.minus-plus-border');
            var giatriborder = $(this).closest('.minus-plus-border').find('#giatriborder').val();
        ...
        $('.control-' + thisControl.id).on('change', '#' + border_color_id, function() {
        ...
        $('.control-' + thisControl.id).on('click', '#' + ng_binding_solid, function() {
        ...
        $('.control-' + thisControl.id).on('click', '#' + ng_binding_dotted, function() {
            var border_style = $(this).attr('data-value');
        ...
        $('.control-' + thisControl.id).on('click', '#' + ng_binding_dashed, function() {
            var border_style = $(this).attr('data-value');
        ...
        $('.control-' + thisControl.id).on('click', '#'+ plus_border_top, function() {
            var input = $(this).closest('.minus-plus-border');
        ...
        $('.control-' + thisControl.id).on('click', '#' + minus_border_top, function() {
            var input = $(this).closest('.minus-plus-border');
            var giatribordertop = $(this).closest('.minus-plus-border').find('#giatribordertop').val();
        ...
        $('.control-' + thisControl.id).on('change', '#' + border_top_color_id, function() {
        ...
        //change border style dropdown solid
        $('.control-' + thisControl.id).on('click', '#' + ng_binding_solid_top, function() {
        ...
        //change border style dropdown dotted
        $('.control-' + thisControl.id).on('click', '#' + ng_binding_dotted_top, function() {
            var border_top_style = $(this).attr('data-value');
        ...
        //change border style dropdown dashed
        $('.control-' + thisControl.id).on('click', '#' + ng_binding_dashed_top, function() {
            var border_top_style = $(this).attr('data-value');
        ...
        //border right color plus
         $('.control-' + thisControl.id).on('click', '#'+ plus_border_right, function() {
            var input = $(this).closest('.minus-plus-border');
        ...
        $('.control-' + thisControl.id).on('click', '#'+ minus_border_right, function() {
            var input = $(this).closest('.minus-plus-border');
            var giatriborderright = $(this).closest('.minus-plus-border').find('#giatriborderright').val();
        ...
        $('.control-' + thisControl.id).on('change', '#' + border_right_color_id, function() {
        ...
        //change border style dropdown solid
        $('.control-' + thisControl.id).on('click', '#' + ng_binding_solid_right, function() {
        ...
        //change border style dropdown dotted
        $('.control-' + thisControl.id).on('click', '#' + ng_binding_dotted_right, function() {
            var border_right_style = $(this).attr('data-value');
        ...
        //change border style dropdown dashed
        $('.control-' + thisControl.id).on('click', '#' + ng_binding_dashed_right, function() {
            var border_right_style = $(this).attr('data-value');
        ...
        //border bottom color plus
         $('.control-' + thisControl.id).on('click', '#' + plus_border_bottom, function() {
            var input = $(this).closest('.minus-plus-border');
        ...
        $('.control-' + thisControl.id).on('click', '#' + minus_border_bottom, function() {
            var input = $(this).closest('.minus-plus-border');
            var giatriborderbottom = $(this).closest('.minus-plus-border').find('#giatriborderbottom').val();
        ...
        $('.control-' + thisControl.id).on('change', '#' + border_bottom_color_id, function() {
        ...
        //change border style dropdown solid
        $('.control-' + thisControl.id).on('click', '#' + ng_binding_solid_bottom, function() {
        ...
        //change border style dropdown dotted
        $('.control-' + thisControl.id).on('click', '#' + ng_binding_dotted_bottom, function() {
            var border_bottom_style = $(this).attr('data-value');
        ...
        //change border style dropdown dashed
        $('.control-' + thisControl.id).on('click', '#' + ng_binding_dashed_bottom, function() {
            var border_bottom_style = $(this).attr('data-value');
        ...
        //border left color plus
         $('.control-' + thisControl.id).on('click', '#' + plus_border_left, function() {
            var input = $(this).closest('.minus-plus-border');
        ...
        $('.control-' + thisControl.id).on('click', '#' + minus_border_left, function() {
            var input = $(this).closest('.minus-plus-border');
            var giatriborderleft = $(this).closest('.minus-plus-border').find('#giatriborderleft').val();
        ...
        $('.control-' + thisControl.id).on('change', '#' + border_left_color_id, function() {
        ...
        //change border style dropdown solid
        $('.control-' + thisControl.id).on('click', '#' + ng_binding_solid_left, function() {
        ...
        //change border style dropdown dotted
        $('.control-' + thisControl.id).on('click', '#' + ng_binding_dotted_left, function() {
            var border_left_style = $(this).attr('data-value');
        ...
        //change border style dropdown dashed
        $('.control-' + thisControl.id).on('click', '#' + ng_binding_dashed_left, function() {
            var border_left_style = $(this).attr('data-value');
        ...
        //click all border
        $('.control-' + thisControl.id).on('click', '#' + all_border, function() {
        ...
        //click four border
        $('.control-' + thisControl.id).on('click', '#' + four_border, function() {
            $('.border-style').html(getI18n('solid'));
            $('.border-style').attr('data-style', 'solid');
            $('#giatriborder').val(0);
